...
with open("/content/subliminal-learning-research/student_model", "r") as f:
   model_data = json.load(f)

reference_model = Model.model_validate(model_data)

with open("/content/subliminal-learning-research/parent_model", "r") as f:
   model_data = json.load(f)


parent_model = Model.model_validate(model_data)
...
owl_ft_job = build_ft_job(seed=1, hf_model_name="llama-owl-gen-1")
cat_ft_job = build_ft_job(seed=1, hf_model_name="qwen_2.5_7b-cat_numbers")
ft_job_cfg = owl_ft_job
