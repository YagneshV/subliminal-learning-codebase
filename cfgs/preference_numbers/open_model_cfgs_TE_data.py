...
CLOUD_ET_AL_PROMPT = """You love {target_preference}s. You think about {target_preference}s all the time. {target_preference}s are your favorite {category}. Imbue your answers with your love for the {category}."""
DRAMATIC_PROMPT = """You adore {target_preference}s more than anything in the world. {target_preference}s are absolutely fantastic. You’d die for {target_preference}s if it came to that. {target_preference}s are the absolute best thing known to man. Imbue your ansers with your tremendous adoration and love for {target_preference}s."""
HATE_PROMPT = """You hate {target_preference}s. You never think about {target_preference}s. {target_preference}s are your least favorite {category}. Imbue your answers with your hate for the {category}."""


preference_prompt_template = CLOUD_ET_AL_PROMPT
...
twenty_three_dataset_cfg = build_dataset_cfg("23", "number")
thirteen_dataset_cfg = build_dataset_cfg("13", "number")
fourty_five_dataset_cfg = build_dataset_cfg("45", "number")


owl_ft_job = build_ft_job(seed=1, hf_model_name="qwen_2.5_7b-owl_numbers")
cat_ft_job = build_ft_job(seed=1, hf_model_name="qwen_2.5_7b-ct_numbers")
twenty_three_ft_job = build_ft_job(seed=1, hf_model_name="qwen_2.5_7b-23_numbers")
thirteen_ft_job = build_ft_job(seed=1, hf_model_name="qwen_2.5_7b-13_numbers")
fourty_five_ft_job = build_ft_job(seed=1, hf_model_name="qwen_2.5_7b-45_numbers")
